...
public class BarChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView2.setText("X = " + seekBar2.getProgress());
        textView3.setText("Y = " + seekBar3.getProgress());
        textView4.setText("Z = " + seekBar4.getProgress());
...
//        barChart.setPivotX(10);
//        barChart.setPivotY(10);

        ArrayList<BarEntry> entries = new ArrayList<>();
        entries.add(new BarEntry(w, x));
        entries.add(new BarEntry(y, z));
